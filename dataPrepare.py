...
# We assume that the Flags.duration is 120
    "watch?v=rVcTPfBxOPU" : [0, 310,460,720,860], #1
    "watch?v=3ymvdQRDHB4"  : [90,520,700,1760,2920,3120,3450,4750,4950,5220,6500,6900,9420,9750], #2
    "watch?v=9ZfN87gSjvI"  : [100,300,500,800,1000,1200,1500,1900,2050,2450,2900], #3
    "watch?v=jCAwNxhqGVE" : [287, 308, 621, 1308, 1538, 1768, 2036, 2181, 2544, 2749, 2867, 3404, 3543, 3842, 4318, 4439,
                    4711, 4900, 7784, 8811, 9450],  # new, old #[4,6,13,14,19] 404
    "watch?v=huqJUghX26Y" : [30,1150,2160,2340,3190,3555], #5 
    "watch?v=R9vcSWb6mug" : [550,940,1229,1460,2220,2900, 3180, 4080, 4340, 4612, 4935, 
                    5142, 5350, 5533, 7068], # new, old #[20,21,27,29,30,35] 404
    "watch?v=MozX3qFIkpQ" : [80,730,970,1230,1470,1740], #7
    "watch?v=1_5n1EfcWyM" : [0,560,1220,1590,1780], #8
    "watch?v=6pxRHBw-k8M" : [0,300,550,800,980,1500], #9
    "watch?v=GzxlyTJD66Q" : [240,900,1040,1300,1970,2130,2530,3020,3300,3620,3830,4300,4700,4960], #10
    "watch?v=HLmOkDBfxv0" : [120,350,540,750,950,1130,1320,1530,1730,1930], #11
    "watch?v=U76OX0M6f4w" : [140,450,670,910,1100,1380,1520,1720], #12
    "watch?v=NCTd1IHChug" : [40,340,490,650,850,1180,1500,1800,2000,2300,2500,2800,3200], #15
    "watch?v=E88TlEyTvkc" : [0,280,1720], #16
    "watch?v=00VaKcv47HA" : [300,430,970,1470,1740,2110,2240,2760,3080,3210,3400,3600], #17
    "watch?v=Bzin4pigkoM"  : [0,210,620,930,1100,1460,1710,2400,2690,3200,3400,3560,3780], #18
    "watch?v=5uv5FVJb-iA" : [835,1380,1520,1700,2370,4880], #22
    "watch?v=lIWKlLZh4yQ" : [480,680,925,1050,1200,1380,1600,1800,2100,2350,2480,2680,3000,3200,3460,4500,4780,
                    5040,5630,5830,6400,6680,7300,7500,7800], #23
    "watch?v=ZuaaId1s5qU" : [300,600,1000,1500,1700,1900,2280,2600,2950,3200,3500,3900,4300,4500], #24
    "watch?v=8HJ7mGUmlO4" : [120,400,700,1000,1300,1500,1750,2150,2390,2550,3100,3400,3800,4100,4400,4800,5100,5500,5800,6300], #25
    "watch?v=oSEaPfnQKFI" : [0,170,340,4380,4640,5140,7300,7470,7620,7860,9190,9370], #26
    "watch?v=qrT7rAY4IpU" : [30,160,400,660,990,2560,2780,3320,3610,5860,6450,7260,7440,8830,9020,9220,9390,], #28
    "watch?v=91Js5bdjc34" : [220,1540,2120,2430,5570,6380,6740],  #31
    "watch?v=HLFI88AEHpY" : [1770,2240,3000,4800,4980,5420,6800],  #32
    "watch?v=57W8GBUzWew" : [110],   #33
    "watch?v=dm6nBhHK0-M" : [140,700,1000,1430,1630,1900,2400,2600,2800,3000,3200,3600,3900,4200,4600,5000,5700,
                    6000,6400,6800,7100,7600,7900,8200],   #34
    "watch?v=o1C9G4WNbnI" : [200,320,440,1200,1320,1560,1680,1800,1920,3445],   #36
    "watch?v=o8Qrv0dTYAU"  : [1260,1380,1880], #37
}
